...
function MyFlexibleContainer({ children }: { children: ReactNode }) {
  if (childrenHasMaterialDesignElements(children)) {
    return <MaterialDesignContainer>{children}</MaterialDesignContainer>;
  }
...
function MyWrappedMaterialButton() {
  return <MaterialButton onClick={() => alert("Ouch")}>Ouch</MaterialButton>;
}
```
...
function MyFlexibleContainer({ children }: { children: ReactNode }) {
  ...
  if (childrenHasMaterialDesignElements(resolved)) {
    return <MaterialDesignContainer>{resolved}</MaterialDesignContainer>;
  }
